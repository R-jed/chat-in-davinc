...
var CLF_DOM = (() => {
   ...
   *
   * Chat in DaVinci remains authoritative for its own call labels/results. This only supplies
   ...
   * recording "Chat in DaVinci Desktop is now connected" as a ChatGPT failure.
   */
  ...
  async function pluginRefreshView(connectorName, expectedTools = [], expectedAppId = null) {
    const externalPlugins = connectorName === 'Chat in DaVinci Plugins';
